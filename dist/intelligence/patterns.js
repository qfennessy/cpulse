...
export function analyzeFilePatterns(sessions) {
...
export function analyzeProjectPatterns(sessions) {
...
export function analyzeTopicPatterns(sessions) {
...
export function analyzeToolUsage(sessions) {
...
export function analyzeWorkingHours(sessions) {
...
export function analyzePatterns(sessions, _commits) {
    return {
...
export function formatPatternSummary(analysis) {
    const lines = [];
