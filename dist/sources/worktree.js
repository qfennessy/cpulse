 ...
 */
export function isWorktree(projectPath) {
 ...
 */
export function getMainRepoPath(worktreePath) {
 ...
 */
export function getWorktreeList(projectPath) {
    try {
 ...
 */
export function inferParentProjectFromName(projectName) {
 ...
 */
export function getParentProject(projectPath, projectName) {
 ...
 */
export function groupByParentProject(items) {
 ...
 */
export function formatProjectWithWorktrees(parentProject, worktrees) {
