...
import { wrapWithNarratives, renderBriefingHtml, renderBriefingPlainText, renderBriefingTerminal, formatMarkdownForTerminal, } from '../presentation/index.js';
function formatBriefingAsMarkdown(briefing) {
    ...
    lines.push(`# cpulse Daily Briefing`);
    lines.push(`*${dateStr}*`);
    lines.push('');
    ...
    lines.push('');
    lines.push('*Generated by cpulse at ' +
...
export async function sendBriefingEmail(config, briefing, signals) {
    ...
    if (signals) {
        ...
        const { opening, cardTransitions, closing } = wrapWithNarratives(briefing.cards, signals, signals.actionItems, signals.quickWins);
 ...
 */
export function formatBriefingForTerminal(briefing, signals) {
    const { opening, cardTransitions, closing } = wrapWithNarratives(briefing.cards, signals, signals.actionItems, signals.quickWins);
 ...
 */
export function formatBriefingAsTerminal(briefing) {
